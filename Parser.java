...
public class Parser {
  ...
  public static Map<String, Map<String, String>> parseConfig(
    File configFile,
    String nodeName
  ) {
  ...
  public static void main(String[] args) {
    ...
    Map<String, Map<String, String>> configDetails = parseConfig(
      new File(filePath),
      "Switch"
    );
    ...
    try {
      Switch switchInstance = new Switch(filePath, 0, null);
